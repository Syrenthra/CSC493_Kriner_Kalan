...
public class WorldRenderer implements Disposable
{
    ...
    private void renderGuiFeatherPowerup(SpriteBatch batch)
    {
        float x =-15;
        float y =30;
        float timeLeftFeatherPowerup = worldController.level.tank.timeLeftBarrelPowerup;
        if(timeLeftFeatherPowerup >0)
        {
            ...
            batch.draw(Assets.instance.barrels.barrels, x, y, 50, 50, 100, 100, 0.35f, -0.35f, 0);
    ...
    private void renderGuiScore(SpriteBatch batch)
    {
        ...
        if(worldController.scoreVisual < worldController.score)
        {
            ...
            offsetX += MathUtils.sinDeg(shakeAlpha * 2.9f) * shakeDist;
        }
        batch.draw(Assets.instance.crate.crate, x, y, offsetX, offsetY, 100, 100, 0.35f, -0.35f, 0);
    ...
    private void renderGuiExtraLive(SpriteBatch batch)
    {
        ...
        if(worldController.lives >=0 && worldController.livesVisual > worldController.lives)
        {
            ...
            batch.draw(Assets.instance.tank.tank, x + i * 50, y, 50, 50, 120, 100, alphaScale, -alphaScale, alphaRotate);
            batch.setColor(1, 1, 1, 1);            
        }
